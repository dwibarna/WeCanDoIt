...
class MovieAndShowViewModel: ViewModel() {
    ...
    fun getListMovie():List<SobanaMovies>{

        val resourceDirectorMovies = arrayListOf(
                "Bradley Cooper",
                "Robert Rodriguez",
                "James Wan",
                "Bryan Singer",
        ...
        val resourceOverviewMovies = arrayListOf(
        ...
        val resourceGenreMovie = arrayListOf(
                "Drama, Romance, Music",
        ...
        val resourceMovieAvatar = arrayListOf(
        ...
        val resourceTitleMovie = arrayListOf(
                "A Star Is Born",
                "Alita: Battle Angel",
                "Aquaman",
                "Bohemian Rhapsody",
